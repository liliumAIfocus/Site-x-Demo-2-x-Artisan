...
import { ArrowUpRight, Check, Clock, Loader2, Mail, MapPin } from "lucide-react";
        ...
        <div className="lg:col-span-6">
          ...
          <div data-reveal className="mt-10" style={{ "--d": "200ms" }}>
            ...
            <InfoRow icon={Clock} label="Horaires">
              {config.horaires?.texte}
              {config.urgence24h && <span className="block text-sm text-paper/55">Urgences : 24 h/24, 7 j/7</span>}
            </InfoRow>
